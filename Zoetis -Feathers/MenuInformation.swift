...
struct MenuInformation {
    ...
    static func allDogs() -> [MenuInformation] {
        return [
            ...
            MenuInformation(title: "Anxious Dog", creator: appDelegate.nameJames, image: UIImage(named: "ID-100120.jpg"), SelIndx: "2"),
            MenuInformation(title: "Husky Dog", creator: appDelegate.nameJames, image: UIImage(named: "ID-100136.jpg"), SelIndx: "3"),
            MenuInformation(title: "Puppy", creator: appDelegate.nameJames, image: UIImage(named: "ID-100140.jpg"), SelIndx: "4"),
            MenuInformation(title: "Black Labrador Puppy", creator: appDelegate.nameJames, image: UIImage(named: "ID-10018395.jpg"), SelIndx: "5"),
        ]
    }
}
